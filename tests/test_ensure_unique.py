...
@pytest.mark.parametrize('original_name,new_name,dir_content,expected', [
    # No rename
    ('bob.jpg', '1234.jpg', ('5678.jpg',),
     '1234.jpg'),
    # Normal rename
    ('bob.jpg', '1234.jpg', ('1234.jpg',),
     '1234_dup001.jpg'),
    ...
    ('1234_dup001.jpg', '1234.jpg', ('1234.jpg', '1234_dup001.jpg'),
     None),
    ('2004-04-13_12-29-00.jpg', '2004-04-13_12-29-00.jpg',
...
def test_ensure_unique(tmpdir, original_name, new_name, dir_content, expected):
    ...
    result = ensure_unique(os.path.join(tmpdir, original_name),
                           *os.path.splitext(new_name))
